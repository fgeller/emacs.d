...
** Custom prefix map
   ...
   #+begin_src emacs-lisp
     ...
     (global-set-key (kbd "C-.") 'c/map-prefix)
...
*** Enable / disable modes
    #+begin_src emacs-lisp
      (define-key c/map "ma" 'auto-complete-mode)
      (define-key c/map "mm" 'magit-status)
...
*** Start different kinds of shells
    ...
    #+begin_src emacs-lisp
      (define-key c/map "se" 'eshell)
      (define-key c/map "sl" 'slime)
      (define-key c/map "sp" 'python-shell-switch-to-shell)
    #+end_src
...
** Buffers
   ...
   #+begin_src emacs-lisp
     ...
     (define-key c/map "bs" 'c/switch-to-scratch-buffer)
     (define-key c/map "bT" 'c/tramp-cleanup)
   #+end_src
...
** General text editing
   ...
   #+begin_src emacs-lisp
     ...
     (define-key c/map "lf" 'flush-lines)
     (define-key c/map "lk" 'keep-lines)
...
** Org mode
   ...
   #+begin_src emacs-lisp
     ...
     (eval-after-load 'org-capture
       '(define-key org-capture-mode-map (kbd "C-c C-x C-u") 'c/org-get-chrome-link))
     (eval-after-load 'org
       '(progn
          (define-key org-mode-map (kbd "C-c t") 'org-todo)
          (define-key org-mode-map (kbd "C-,") 'helm-find-files)))
   #+end_src
...
** Fonts
   ...
   #+begin_src emacs-lisp
     ...
     (setq c/mono-space-font-family "Menlo")
    ...
    #+begin_src emacs-lisp
      (setq org-capture-templates
            `(("t" "Task"
              ...
              ("w" "Work task"
               entry (file+headline ,c/work-org-default-notes-file "Tasks")
               "* TODO %?\n  SCHEDULED: %(org-insert-time-stamp (org-read-date nil t \"\"))\n\n  %a\n  %i\n")
              ("n" "Note"
