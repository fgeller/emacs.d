...
*** require'd
   ...
   #+end_src
    ...
    #+begin_src emacs-lisp
      ;; single quote
      (dolist (mode '(emacs-lisp-mode magit-log-edit-mode))
    ...
    #+begin_src emacs-lisp
      (setq org-agenda-custom-commands
            `(("d" . "Completed / archived items")
              ...
              ("ii" "[i]nbox tagged tasks" tags "+inbox-SCHEDULED={.+}/!+TODO|+STARTED")
              ("wi" "[w]ork tasks that are not scheduled" tags "+inbox+work-SCHEDULED={.+}/!+TODO|+STARTED")
