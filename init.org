...
** Load path
   ...
   #+begin_src emacs-lisp
     ...
     (add-to-list 'load-path (expand-file-name "~/.emacs.d/src/sort-imports"))
     (add-to-list 'load-path (expand-file-name "~/.emacs.d/src/helm"))
     (add-to-list 'load-path (expand-file-name "~/.emacs.d/src/helm-ls-git"))
     (add-to-list 'load-path (expand-file-name "~/.emacs.d/src/async"))
   #+end_src
