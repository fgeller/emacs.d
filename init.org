   ...
   #+begin_src emacs-lisp
     (defun c/god-mode-update-cursor ()
       (cond (god-local-mode
             ...
             (t (set-face-background 'fringe (if (or terminal-p (not (boundp 'flatui-colors-alist))) "black" (cdr (assoc "wet-asphalt" flatui-colors-alist)))))))
...
** Theme
  ...
  Use solarized colors for ansi colors.

  #+begin_src emacs-lisp :tangle no
    (unless terminal-p
      (eval-after-load 'compile
        '(progn
           (setq ansi-color-names-vector ["#0a2832" "#c60007" "#728a05" "#a57705" "#2075c7" "#c61b6e" "#259185" "#e9e2cb"])
