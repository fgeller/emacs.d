...
** Jumping
   ...
   #+begin_src emacs-lisp
     (define-key global-map (kbd "C-l C-c C-l") 'goto-line)
     (define-key global-map (kbd "C-l C-c C-c") 'ace-jump-mode)
     (define-key global-map (kbd "C-l C-c C-m") 'back-button-local)
     (define-key global-map (kbd "C-l C-c C-w") 'ace-window)
   #+end_src
...
** C-c Map
   ...
   #+begin_src emacs-lisp
     ...
     (define-key global-map (kbd "C-l C-a C-q") 'ag-project-at-point)
     (define-key global-map (kbd "C-l C-a C-d") 'ag)
     (define-key global-map (kbd "C-l C-a C-s") 'c/helm-ag)
     (define-key global-map (kbd "C-l C-a C-a") 'c/helm-ag-project)
   ...
   #+begin_src emacs-lisp
     (define-key global-map (kbd "C-c C-/ C-d") 'toggle-debug-on-error)
     (define-key global-map (kbd "C-c C-/ C-h") 'mode-line-in-header)
   ...
   #+begin_src emacs-lisp
     ...
     (eval-after-load 'org
       '(progn
          ...
          (define-key org-mode-map (kbd "C-c C-o C-q") 'org-set-tags-command)
