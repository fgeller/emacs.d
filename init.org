...
** GNU Global
   ...
   #+begin_src emacs-lisp
     (defun c/gtags-update-single (filename gtags-root)
       ...
       (interactive)
       (let ((command (concat "cd " gtags-root " ; GTAGSLABEL=ctags GTAGSCONF=/usr/local/share/gtags/gtags.conf gtags -v --debug -i --single-update " filename )))
...
** god-mode
   ...
   #+begin_src emacs-lisp
     (key-chord-define-global "xm" 'god-mode-all)
   #+end_src
...
** Text editing
   ...
   #+begin_src emacs-lisp
     (defun c/subword-kill-backwards ()
       (interactive)
       (backward-word)
       (subword-kill 1))
   #+end_src
   ...
   #+begin_src emacs-lisp
     (define-key global-map (kbd "C-z C-a") 'c/zap-up-to-char-backwards)
     (define-key global-map (kbd "C-z C-s") 'zap-up-to-char)
     (define-key global-map (kbd "C-z C-z") 'zap-up-to-char)
     (define-key global-map (kbd "C-z C-d") 'subword-kill)
     (define-key global-map (kbd "C-z C-w") 'c/subword-kill-backwards)
